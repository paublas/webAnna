...
export class ProjectsComponent implements OnInit {
  ...
  scrollingText_L(){
    if(this.global.idioma == 'cat') return "<3 ¡EI! T'AGRADA EL QUE VEUS? PODEM TREBALLAR PLEGATS!! <3 ENS PODEM POSAR EN CONTACTE A MOREUNISTUFF@GMAIL.COM ;) EM POTS TROBAR A INSTAGRAM @NANA.DENADA (*O*) O BÉ A TRAVÉS D'AQUEST NÚMERO +34655826439";
